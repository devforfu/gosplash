...
//func (t *ThumbnailMaker) Create(format ImageFormat) (err error) {
//    in, err := os.Open(t.In)
//    if err != nil { return }
//    defer in.Close()
//
...
//}
//
//func (t *ThumbnailMaker) Convert(w io.Writer, r io.Reader, format ImageFormat) error {
...
//func ThumbnailsFromFolder(dirname string, patterns string, format ImageFormat) (thumbs []string, err error) {
